...
public class Composer extends AppCompatActivity {
    ...
    private void startCamera() {
        ...
        //ImageAnalysis imageAnalysis = new ImageAnalysis.Analyzer().analyze();
        //HdrImageCaptureExtender hdrImageCaptureExtender = new HdrImageCaptureExtender.create(ImageCapture.Builder());

        findViewById(R.id.flip_camera).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                File folder = new File(Environment.getExternalStorageDirectory() + "/Revere/Videos");
                if(!folder.exists()){
                    folder.mkdirs();
                }
                File file = new File(Environment.getExternalStorageDirectory()
                        + "/Revere/Videos/" + System.currentTimeMillis() + ".jpg");
